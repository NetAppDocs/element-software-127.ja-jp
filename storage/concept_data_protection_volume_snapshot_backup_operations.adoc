...
* link:task_data_protection_back_up_a_volume_snapshot_to_an_amazon_s3_object_store.html["Amazon S3 オブジェクトストアにボリューム Snapshot をバックアップします"]
* link:task_data_protection_back_up_a_volume_snapshot_to_openstack_swift.html["OpenStack Swift オブジェクトストアにボリューム Snapshot をバックアップします"]
* link:task_data_protection_back_up_volume_to_solidfire.html["ボリューム Snapshot を SolidFire クラスタにバックアップします"]
